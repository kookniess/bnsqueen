const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    { title: '华熙赵燕针对我这个吹哨人的精准猎杀...', url: 'https://david.bnsqueen.com' }, // 链接到小说第一章
    { title: '千亿华熙隐藏的权力与阴谋？点击揭秘', url: 'https://youtube.com/@bnsqueen_com' }, // 链接到“故事宇宙”或小说简介页面
  ],
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '吹哨人公益基金', url: '/latest' },
